...
- **Inactivity auto-logout (v1.9.8 → v1.10.3):** `InactivityMonitor` (20 min, `kInactivityTimeoutMinutes`) — gesture-poked, lifecycle-aware (background-trip elapsed check). Documented in CU-26.
